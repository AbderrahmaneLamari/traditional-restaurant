...
export default async function AdminDashboardPage() {
    ...
    try {
        ...
        const [data, menuItems, ordersItems,overviewData, top, revenueTrend] = await Promise.all(
            [summaryData.json(),
        ...
        return <AdminDashboard initialSummary={data} menuItems={menuItems} orderItems={ordersItems} analytics={{ topMenuItems: top, overviewData: overviewData, revenueTrend: revenueTrend }} />
