...
export default async function AdminDashboardPage() {
    ...
    try {
        ...
        const [summaryData, MenuManagementProps, orders, top_res, revenue_res] = await Promise.all([
        ...
        const [data, menuItems, ordersItems, top, revenueTrend] = await Promise.all(
            [summaryData.json(),
        ...
        return <AdminDashboard initialSummary={data} menuItems={menuItems} orderItems={ordersItems} analytics={{ topMenuItems: top, revenueTrend: revenueTrend }} />
